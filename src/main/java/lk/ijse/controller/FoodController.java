...
import lk.ijse.view.tdm.FoodTm;
...
public class FoodController {
    ...
    void btnEditOnAction(ActionEvent event) {
        ...
        if (b){
            ...
            try {
                boolean isSaved = foodBO.updateFood(dto);
                if (isSaved) {
    ...
    private void generateNextFoodId() {
        try {
            String foodId = foodBO.generateNewFoodId();
    ...
    private void loadAllFood() {
        try {
            List<FoodDto> dtoList = foodBO.getAllAnimalFood();
    ...
    private void deleteFood(String code) {
        try {
            boolean isDeleted = foodBO.deleteFood(code);
            if(isDeleted)
